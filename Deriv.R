# Deriv.R -- symbollic differentiation
# written by Andrew Clausen <clausen@econ.upenn.edu> in 2007
#
# This file contains two useful functions: Deriv() for differentiating
# expressions, and Deriv.function() for differentiating functions symbolically.
# It uses Simplify.R (available at www.econ.upenn.edu/~clausen/computing).
#
...
#  * It's easy to add custom entries to the derivatives table.  It could be
...
#  * The output is an executable function, which makes it suitable for use in
# optimization problems.
#
# BAD POINTS:
#  * Differentiating vector-valued functions doesn't work properly, since
